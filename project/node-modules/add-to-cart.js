...
function item_cart(id, image, name, price, description, amount) {
    this.id = id;
    this.image = image;
    this.name = name;
    this.price = price;
...
export {renderProduct,loadProducts,  loadMessCart, renderCart, countAdd, addToCart, countMinus,deleteFromCart }