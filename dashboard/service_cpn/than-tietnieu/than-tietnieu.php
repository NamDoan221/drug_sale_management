    ...
    <div class="container">
      <div class="card-service-background">
        <div class="care-service-banner">
          <div class="top-care-service-content">
            <div class="inner">
              ...
              <div class="title">
                <h1>Thận & Tiết niệu</h1>
              </div>
              <div class="sub-text">
                <span
                  >Các Bác sĩ chuyên khoa Thận sẽ giúp bạn và người thân kiểm
                  soát tốt bệnh thận mãn tính và các vấn đề về huyết áp.</span
                >
              </div>
          ...
          <div class="banner-image">
            <img
              src="https://cdn.jiohealth.com/jio-website/home-page/jio-website-v2020-06-19-16-06-13/assets/images/care-service-background/nephrology-banner.svg"
              alt=""
            />
          </div>
        </div>
        <div class="common-conditions">
          <div class="title-container">
            ...
            />
            <h2 class="title">
              Bệnh lý Thận & Tiết niệu được điều trị bởi đội ngũ Bác sĩ chuyên
      ...
      <div class="meet-doctor">
        <div class="meet-doctor-title">
          <span>Gặp Gỡ các Bác Sĩ chuyên khoa Thận & Tiết niệu</span>
        </div>
        <div class="meet-doctor-content row">
          <div class="col">
            <div class="card-doctor">
              ...
              <div class="card-body">
                ...
                <p class="card-description">Nội thận</p>
                <p class="card-price">
          ...
          <div class="col">
            <div class="card-doctor">
              <div class="card-header">
                <img
                  src="https://jio-prod-sg.s3.ap-southeast-1.amazonaws.com/user-profile-image/6941/9d1c26aa-f907-47d5-af52-7b7137e984cd?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20200620T005537Z&X-Amz-SignedHeaders=host&X-Amz-Expires=39862&X-Amz-Credential=AKIAJXE3JAGP6DYWLLQA%2F20200620%2Fap-southeast-1%2Fs3%2Faws4_request&X-Amz-Signature=6e62c383ba75b17502b56a83bd51e7e87ea0951efe65b21c3c8535fac5d399d2"
                  class="img-card"
                  alt=""
                />
              </div>
              <div class="card-body">
                <h5 class="card-title">Nguyễn Sơn Lâm</h5>
                <p class="card-description">Nội thận</p>
                <p class="card-price">
                  <i class="fa fa-heart"></i>
                  <i class="fa fa-heart"></i>
          ...
          <div class="col">
            <div class="card-doctor">
              <div class="card-header">
                <img
                  src="https://jio-prod-sg.s3.ap-southeast-1.amazonaws.com/user-profile-image/109408/ecd6a2f4-b6ca-4107-80ae-4e907d08643d?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20200620T005537Z&X-Amz-SignedHeaders=host&X-Amz-Expires=39862&X-Amz-Credential=AKIAJXE3JAGP6DYWLLQA%2F20200620%2Fap-southeast-1%2Fs3%2Faws4_request&X-Amz-Signature=c8e6a9703e0e4c5e439d4b8a5c4ae60a3d6cebd63c3e196787110353d6a8771b"
                  class="img-card"
                  alt=""
                />
              </div>
              <div class="card-body">
                <h5 class="card-title">Nguyễn Ngọc Lan Anh</h5>
                <p class="card-description">Nội thận</p>
                <p class="card-price">
                  <i class="fa fa-heart"></i>
                  <i class="fa fa-heart"></i>
          ...
          <div class="col">
            <div class="card-doctor">
              <div class="card-header">
                <img
                  src="https://jiohealth.com/assets/icons/doctor-placeholder.svg"
                  class="img-card"
                  alt=""
                />
              </div>
              <div class="card-body">
                <h5 class="card-title">Nguyễn Thị Bích Phượng</h5>
                <p class="card-description">Nội thận</p>
                <p class="card-price">
                  <i class="fa fa-heart"></i>
                  <i class="fa fa-heart"></i>
        ...
        <div class="explain-content row">
            ...
            <div class="card-explain">
              ...
              <div class="explain-body">
                <span
                  ...
                  chức năng. Một chức năng quan trọng của thận là lọc tất cả
                  chất độc và nước dư thừa từ máu. Khi thận bị suy yếu, các chất
                  độc hại sẽ tích tụ.</span
                >
              </div>
            </div>
          </div>
          <div class="col ttl">
            <div class="card-explain">
              ...
              <div class="explain-body">
                <span
                  >Các triệu chứng bệnh thận thường tiến triển rất chậm và khó
                  nhận biết. Một số người bệnh không có triệu chứng nên chỉ phát
                  hiện bệnh sau khi làm xét nghiệm.</span
                >
              </div>
            </div>
          </div>
            ...
            <div class="card-explain">
              ...
              <div class="explain-body">
                <span
                  ...
                  giai đoạn sau của bệnh, có thể cần lọc máu bằng máy (chạy
                  thận) hoặc cấy ghép.</span
                >
              </div>
            </div>
          </div>
