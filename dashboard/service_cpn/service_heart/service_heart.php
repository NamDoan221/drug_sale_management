<?php
    $query = "SELECT * FROM `doctor` WHERE type = 'tim'";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./service_heart.css" />
    <link
      rel="stylesheet"
    ...
    <div class="container" style="padding-top: 63px">
      ...
      <div id="intro" class="d-flex flex-wrap pt-5 pb-5">
        <div class="col-12 col-lg-4">
          <h1 class="title-box">Tim mạch</h1>
          <p class="text">
            Điều trị bệnh lý tim mạch (tăng huyết áp, bệnh mạch vành, suy tim,
            rối loạn mỡ máu)
          </p>
        ...
        <div class="col-12 col-lg-8 pt-4">
          <img
            src="../../../assets/cardiology-banner.svg"
            alt=""
            width="100%"
            height="auto"
          />
      ...
      <div id="doctor-box" class="pt-5 pb-5">
        <h1 class="title-sub">Gặp gỡ bác sĩ khoa tim mạch</h1>
      ...
      <div id="info" class="p-5">
        <h1 class="title-sub">Thông tin về bệnh Tim</h1>
        <div class="d-flex flex-wrap justify-content-center w-100 m-0">
          ...
          >
            <div class="p-3">
              <p class="box-title">Bệnh Tim là gì?</p>
              <p class="box-text">
                Bệnh tim là bệnh khi các mạch máu bị hẹp hoặc tắc nghẽn dẫn đến
                đau tim, đau ngực, hoặc đột quỵ. Các chứng bệnh khác ảnh hưởng
                đến cơ, van tim hay nhịp tim cũng được coi là các dạng bệnh tim.
              </p>
            </div>
            <img
          ...
          >
            <div class="p-3">
              ...
              <p class="box-text">
                Bệnh tim mạch có thể không gây ra triệu chứng gì hoặc gây khó
                thở, đau ngực hoặc đau tim.
              </p>
            </div>
            <img
              src="../../../assets/background-card.svg"
          ...
          >
            <div class="p-3">
              <p class="box-title">Điều trị</p>
              <p>Việc điều trị bao gồm:</p>
              <ul class="pl-5">
