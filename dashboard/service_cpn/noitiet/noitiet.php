<?php
    $query = "SELECT * FROM `doctor` WHERE type='noitiet'";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./noitiet.css" />
    <link
      rel="stylesheet"
    ...
    <div class="container" style="padding-top: 63px">
      ...
      <div id="intro" class="d-flex flex-wrap pt-5 pb-5">
        <div class="col-12 col-lg-4">
          <h1 class="title-box">Nội Tiết</h1>
          <p class="text">
            Điều trị các bệnh nội tiết như đái tháo đường, rối loạn tuyến
            giáp...
          </p>
        ...
        <div class="col-12 col-lg-8 pt-4">
          <img
            src="../../../assets/endocrinology-banner.svg"
            alt=""
            width="100%"
            height="auto"
          />
      ...
      <div id="doctor-box" class="pt-5 pb-5">
        <h1 class="title-sub">Gặp gỡ bác sĩ khoa nội tiết</h1>
      ...
      <div id="info" class="p-5">
        <h1 class="title-sub">Thông tin về Đái tháo đường</h1>
        <div class="d-flex flex-wrap justify-content-center w-100 m-0">
          ...
          >
            <div class="p-3">
              <p class="box-title">Thông tin về Đái tháo đường</p>
              <p class="box-text">
                Đái tháo đường là bệnh mà cơ thể không sản xuất hoặc đáp ứng với
                hóc-môn insulin, dẫn đến chuyển hóa bất thường cacbohydrates và
                gia tăng nồng độ đường trong máu và nước tiểu.
              </p>
            </div>
            <img
          ...
          >
            <div class="p-3">
              ...
              <p class="box-text">
                Các triệu chứng bao gồm khát nước, thường xuyên đi tiểu, đói,
                mệt mỏi và mờ mắt.
              </p>
            </div>
            <img
          ...
          >
            <div class="p-3">
              ...
              <p class="box-text">
                Duy trì lượng đường trong máu bằng việc theo dõi thường xuyên,
                liệu pháp insulin, thuốc men, chế độ ăn uống và tập thể
                dục./span >
              </p>
            </div>
            <img
