...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-item nav-link active" href="#">Thuốc bán theo chỉ định</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-item nav-link active" href="#">Thuốc đặc trị</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-item nav-link active" href="#">Thực phẩm chức năng</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-item nav-link active" href="#">Dược mỹ phẩm</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-item nav-link active" href="#">Dụng cụ y tế</a>
                    </li>
                </ul>
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    <form class="form-inline my-2 my-lg-0" method="POST">
                      <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="key">
                      <button type="submit" name="search" class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                    </form>
        ...
        <div class="mx-5 d-flex justify-content-center" style="margin-top: 100px; margin-bottom: 20px; height: calc(100vh - 175px); overflow-y: auto;">
            <div class="row w-100">
            <?php while($row = mysqli_fetch_array($filter_result)) :?>
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-3" style="width: 18rem;">
                    <div class="card">
                      <img class="card-img-top" src="<?php echo $row['image']; ?>" alt="Card image cap" height="200" width="286">
                      <div class="card-body d-flex flex-column justify-content-around">
                        <div>
                            <h5 class="card-title"><?php echo $row['name']; ?></h5>
                        </div>
                        <div>
                            <span class="card-text text-truncate d-block"><?php echo $row['description']; ?></span>
